/*
 * This program takes a name that is entered and splits it out and shows the 
 * names seperately: first, middle (if three entered) and last
 * 
 * Author: Wendell Slagell
 * Date: 11-19-2019
 */
